...
# ============================================================
# EXPERIMENT 1
# BASELINE QUANTUM TELEPORTATION
# ============================================================
...
# Prepare arbitrary quantum state using Ry rotation
...
# ============================================================
# STEP 5: HARSH APPLIES CLASSICAL CORRECTIONS
# ============================================================

# If classical bit 1 == 1 -> apply X gate

with qc.if_test((qc.clbits[1], 1)):
    qc.x(2)

# If classical bit 0 == 1 -> apply Z gate
...
for outcome, count in counts.items():
    ...
    # Rightmost bit corresponds to Harsh's qubit
    harsh_bit = outcome[0]
